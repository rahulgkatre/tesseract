...
pub fn where(mask: anytype, true_value: anytype, false_value: anytype) Where(tensor_typing.TensorTypeOf(mask), tensor_typing.TensorTypeOf(true_value), false_value) {

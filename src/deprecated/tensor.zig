...
test "binaryFn" {
    ...
    try std.testing.expect(Graph.AnyTensor.get((&tensor3)).last_op.BinaryOp.a.last_op.TypeOp.x == Graph.AnyTensor.get((&tensor1)));
    try std.testing.expect(Graph.AnyTensor.get((&tensor3)).last_op.BinaryOp.b.last_op.TypeOp.x == Graph.AnyTensor.get((&tensor2)));
}
...
test "binaryFn reduce" {
    ...
    try std.testing.expect(anon.last_op.BinaryOp.a.last_op.TypeOp.x == Graph.AnyTensor.get((&tensor1)));
    try std.testing.expect(anon.last_op.BinaryOp.b.last_op.TypeOp.x == Graph.AnyTensor.get((&tensor2)));
}
